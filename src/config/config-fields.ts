...
export const configFieldCatalog: readonly ConfigFieldDefinition[] = [
  ...
  field('execution.passEnv', 'string_list'), field('execution.recordPrompts', 'boolean'), field('execution.isolateRunnerSettings', 'boolean'), field('execution.commandTimeoutSeconds', 'integer'), field('ui.workspaceDepth', 'integer', GLOBAL, 'server_restart'), field('ui.allowedHosts', 'string_list', GLOBAL, 'server_restart'), field('ui.pairing.enabled', 'boolean', GLOBAL, 'server_restart'),
